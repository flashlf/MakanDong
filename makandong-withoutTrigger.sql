...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2020 at 02:15 PM
...
CREATE TABLE IF NOT EXISTS `foodbeve` (
...
('1337', 'Normal', 'Cobalah Mengerti', '2020-02-20', 0, 95000);
...
ALTER TABLE `inventory`
  ADD PRIMARY KEY (`no`), ADD UNIQUE KEY `mCode` (`mCode`);
...
ALTER TABLE `orderdetail`
  ADD KEY `orderID` (`orderID`), ADD KEY `fkOrderDetail_fbCode` (`fbCode`);
...
--
ALTER TABLE `recipe`
  ADD KEY `fkRecipe_fbCode` (`fbCode`), ADD KEY `fkRecipe_mCode` (`mCode`);

--
-- Indexes for table `supplier`
--
ALTER TABLE `supplier`
  ADD PRIMARY KEY (`sCode`), ADD KEY `fkSupplier_mCode` (`mCode`);
